...
namespace IGT.TestFramework.EGM
{
    public interface ICompactEGM
    {
        ...
        /// </summary>
        /// <param name="connectionStr">The connection string to use
        /// (i.e. IP address 10.21.x.x .).</param>
        /// <returns>True for a successful connection, false otherwise.</returns>
        bool ConnectIp(string ip = "127.0.0.1");
        ...
        /// <summary>
        /// Event that is raised when the EGM is disconnected.
        /// </summary>
        event EventHandler<EGMDisconnectArgs> EGMDisconnected;
    }
    ...
    public class EGMDisconnectArgs : EventArgs
    {
        public EGMDisconnectArgs(string details)
        {
            Details = details;
        }
